...
- [TestSprite MCP Server installed](/mcp/installation) 
- Your IDE open
</Info>
...
<Accordion title="View Detailed Steps">
...
<Columns cols={2}>
  <Card title="Complete Testing Workflow" href="/workflow">
  ...
  <Card title="Contribute on Github" arrow="true" href="https://github.com/testsprite/testsprite-mcp">
