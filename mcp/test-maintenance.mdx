...
<Tabs>
  <Tab title="Re-run All Tests">
    ...
    ```text Example Prompt
    Hey, can you re-run existing TestSprite tests for me?
    ```
...
<Tabs>
  ...
  <Frame>
    ...
    1. Open your TestSprite test plan file (e.g. `testsprite_test_plan.md`).
...
1. Open the TestSprite test plan file. (`testsprite_frontend_test_plan.json`)
...
<div className="full-width-table" style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '0' }}>
  ...
  <div className="table-cell" style={{ padding: '8px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Edit specific test case descriptions → prompt rerun</div>
  ...
  <div className="table-cell" style={{ padding: '8px', fontSize: '14px', borderBottom: '1px solid var(--table-border-color, #e5e7eb)' }}>Delete `testsprite_tests` folder → prompt rerun project tests</div>
  <div className="table-cell" style={{ padding: '8px', fontSize: '14px' }}>**Add/import**</div>
  <div className="table-cell" style={{ padding: '8px', fontSize: '14px' }}>Append new cases in test plan → rerun to generate code</div>
</div>
