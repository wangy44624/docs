...
description: "Solutions to common issues encountered with TestSprite MCP Server."
icon: "bug"
---
...
<Steps>
  ...
  <Step title="Clear npm cache and verify">
    ```bash
...
<Tab title="Node.js Version Compatibility">
...
<Note>Node.js 22 is required for optimal compatibility with TestSprite MCP Server features and dependencies.</Note>
  <Steps>
    ...
    <Step title="If version is below 22, upgrade Node.js">
      <Tabs>
...
<Tabs>
  <Tab title="Verify JSON Configuration">
    <Tabs>
  ...
  <Tab title="Configuration Files">
    **Configuration File Locations:**
    ...
    <Tabs>
      <Tab title="Check Files (macOS/Linux)">
        ```bash
