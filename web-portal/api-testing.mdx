...
Simplify API testing with TestSprite's AI-powered backend testing. Perform comprehensive end-to-end tests for RESTful APIs with speed and precision—designed for teams of any size.
...
<Steps>
  <Step title="Create New Test">
    Navigate to [TestSprite Dashboard](https://www.testsprite.com/dashboard/testing) and click **Create a Test** or select **New Test** from the sidebar
  </Step>
...
[GenRex API Reference](https://docs.genrex.com/docs/1.0/api-reference/request-generation) - Shows how comprehensive API docs help our AI generate better tests
</Accordion>
